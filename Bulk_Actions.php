          ...
          <div class="grid_3">
           ...
           <div class="grid_12">
              ...
              <div class="grid_9">
                                        ...
                                        <h2 style="padding-top:20px;color:#0d78a9; font-size:30px">Bulk Actions</h2>

                                              <form  action="#" method="post" class="bulk_actions">
                                                <div class="form-group">
                                                  <label class="mr-sm-2" for="inlineFormCustomSelect">Bulk Option:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                                ...
                                                <div class="form-group">
                                                  <label class="mr-sm-2" for="inlineFormCustomSelect">Enter List:</label>

                                                </div>
                                                <div class="form-group">
                                                  <label class="mr-sm-2" for="inlineFormCustomSelect">Choose Platform:</label>
                                                  <select class="custom-select mr-sm-2 w-50" id="inlineFormCustomSelect">
                                                    <option selected>Choose...</option>
                                                  ...
                                                  <button type="button" name="butto">Go</button>
