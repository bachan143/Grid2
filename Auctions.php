      ...
      <div class="container_12">
          <div class="grid_3">
           ...
           <div class="grid_12">
              ...
              <div class="grid_9">
                  <h3  style="padding-top:20px;color:#0d78a9; font-size:30px;">My Auctions</h3>
                <div class = "tabinator">

                    <input type = "radio" id = "tab1" name = "tabs" checked>
                    <label for = "tab1">ViewAll</label>
                    <input type = "radio" id = "tab2" name = "tabs">
                    <label for = "tab2">Today Only</label>
                 ...
                 <p class=""><a href="#">Bid on Selected</a></p>
